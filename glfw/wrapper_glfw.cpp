/**
	Taken from the lab materiels provided for AC41004

	setCursorCallback function added
 */
...
GLWrapper::GLWrapper(int width, int height, const char *title) {
	...
	glfwSetWindowTitle(window, "Assignment 2 - Matthew Foulis");
...
void GLWrapper::setCursorCallback(void(*func)(GLFWwindow* window, double xpos, double ypos))
{
